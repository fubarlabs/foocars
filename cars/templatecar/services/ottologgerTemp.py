...
try:
  while True:
    if GPIO.input(SWITCH_collect_data):
      GPIO.wait_for_edge(SWITCH_collect_data, GPIO.FALLING)
    else:
      GPIO.output(LED_collect_data, GPIO.HIGH)
    ...
    with picamera.PiCamera() as camera:
      ...
      GPIO.output(LED_collect_data, GPIO.LOW)
